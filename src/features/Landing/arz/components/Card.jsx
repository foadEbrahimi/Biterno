...
export function ArzCardSkeleton() {
  return (
    <div className="flex h-[8.5rem] animate-pulse cursor-pointer items-center justify-between gap-12 rounded-full bg-white px-10 shadow">
...
export default function CardArz({ name, image, price, change24h }) {
  return (
    <div className="flex w-[15rem] max-w-[23rem] cursor-pointer items-center justify-between gap-5 rounded-full bg-white px-5 py-6 shadow-lg transition-all duration-300 hover:shadow-lg dark:border dark:border-white/50 dark:bg-[#161618] sm:h-[7rem] sm:w-[20rem] sm:px-8 md:h-[8.5rem] md:w-full md:gap-12 md:px-10 xl:!min-w-[90%] xl:!max-w-[90%]">

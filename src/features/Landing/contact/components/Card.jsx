  ...
  return (
    <div className="rounded-2xl bg-white p-3 pb-12 hover:shadow-xl xl:max-w-[25rem]">
      ...
      <div className="mt-10 space-y-2 pb-12 text-center">
        ...
        <p className="!pt-3 font-vazirMedium text-[#777E90]">
          ما ایده ها را از ساده تا پیچیده درک می کنیم، استفاده از همه چیز آسان
          می شود و به بالقوه ترین مشتریان دسترسی پیدا می کند.
        </p>
      </div>
      <button className="hover:border-primary hover:bg-primary mx-auto flex rounded-full border-2 px-5 py-2 font-vazirDemiBold text-[16px] transition-all duration-200 hover:text-[#FCFCFD]">
        خرید کریپتو
      </button>
    </div>
  );

  ...
  return (
    <div className="mt-20 flex flex-col gap-5 sm:flex-row sm:items-center lg:mb-24 lg:mt-0 xl:mb-32">
      <div className="flex flex-col ~gap-5/9 sm:flex-1">
        <h1 className="font-bold !leading-[3rem] ~text-4xl/6xl dark:text-white xl:!leading-[4.5rem]">
          قیمت لحظه ای <br /> ارزهای دیجیتال
        </h1>
        <span className="text-[#353945] ~text-sm/xl dark:text-white/60">
          ارزش کنونی بازار جهانی کریپتو{" "}
